...
//         chai.request(server)
//           .get('/announcements/files/' + filePublicIDExample + '?' + access_token)
//           .end((err, res) => {
...
//         chai.request(server)
//           .get('/announcements/files/' + filePublicIDExample)
//           .end((err, res) => {
//             res.should.have.a.property('header')
//             res.should.have.a.property('body')
//             let header = res.header
...
//         chai.request(server)
//           .get('/announcements/files/' + filePrivateIDExample + '?' + access_token)
//           .end((err, res) => {
//             res.should.have.a.property('header')
//             res.should.have.a.property('body')
//             let header = res.header
...
//         chai.request(server)
//           .get('/announcements/files/' + filePrivateIDExample)
//           .end((err, res) => {
...
//         chai.request(server)
//           .get('/announcements/files/' + randomID + '?' + access_token)
//           .end((err, res) => {
//             console.log(res)
//             res.should.have.status(500)
//             done()
...
//         chai.request(server)
//           .get('/announcements/files/' + announcementPublicIDExample + '/downloadAll?' + access_token)
//           .end((err, res) => {
//             res.should.have.a.property('header')
//             res.should.have.a.property('body')
//             let header = res.header
...
//         chai.request(server)
//           .get('/announcements/files/' + announcementPublicIDExample + '/downloadAll')
//           .end((err, res) => {
//             res.should.have.a.property('header')
//             res.should.have.a.property('body')
//             let header = res.header
...
//         chai.request(server)
//           .get('/announcements/files/' + announcementPrivateIDExample + '/downloadAll')
//           .end((err, res) => {
//             res.should.have.status(500)
//             done()
//           })
...
//         let randomID = mongoose.Types.ObjectId()
//         chai.request(server)
//           .get('/announcements/files/' + randomID + '/downloadAll')
//           .end((err, res) => {
//             res.should.have.status(500)
//             done()
//           })
...
//         chai.request(server)
//           .get('/announcements/files/' + filePublicIDExample + '/view?' + access_token)
//           .end((err, res) => {
//             res.should.have.a.property('header')
//             res.should.have.a.property('body')
//             let header = res.header
...
//         chai.request(server)
//           .get('/announcements/files/' + filePublicIDExample + '/view')
//           .end((err, res) => {
//             res.should.have.a.property('header')
//             res.should.have.a.property('body')
//             let header = res.header
...
//         chai.request(server)
//           .get('/announcements/files/' + filePrivateIDExample + '/view?' + access_token)
//           .end((err, res) => {
//             res.should.have.a.property('header')
//             res.should.have.a.property('body')
//             let header = res.header
...
//         chai.request(server)
//           .get('/announcements/files/' + filePrivateIDExample + '/view')
//           .end((err, res) => {
//             res.should.have.status(500)
//             done()
//           })
...
//         let randomID = mongoose.Types.ObjectId()
//         chai.request(server)
//           .get('/announcements/files/' + randomID + '/view')
//           .end((err, res) => {
//             res.should.have.status(500)
//             done()
//           })
...
//         chai.request(server)
//           .delete('/announcements/files/' + fileIDToBeDeleted + '?' + access_token)
//           .end((err, res) => {
//             res.should.have.status(200)
//             done()
//           })
...
//         chai.request(server)
//           .delete('/announcements/files/' + fileIDToBeDeleted)
//           .end((err, res) => {
